...
case "$TERM" in
xterm*|rxvt*)
    PS1="\[\033[0;31m\]\342\224\214\342\224\200\$([[ \$? != 0 ]] && echo \"[\[\033[0;39m\]\342\234\227\[\033[0;31m\]]\342\224\200\[\033[0;37m\]\")$(if [[ ${EUID} == 0 ]]; then echo '\[\033[101;92m\]root\[\033[49;31m\]\[\033[01;33m\]'; else echo '\[\033[0;39m\]\u\[\033[01;33m\]'; fi)@\[\033[01;96m\]\h\[\033[0;31m\]//\[\033[0;92m\]\$(date +'%H:%M:%S %d%b%Y') \[\033[0;31m\][\[\033[0;34m\] \w \[\033[0;31m\]] \$(parse_git_branch)\r\n\342\224\224 \[\033[01;33m\]\\$ \[\033[0;39m\]"
    ;;
screen)
    PS1="\[\033[0;31m\]\342\224\214\342\224\200\$([[ \$? != 0 ]] && echo \"[\[\033[0;39m\]\342\234\227\[\033[0;31m\]]\342\224\200\[\033[0;37m\]\")$(if [[ ${EUID} == 0 ]]; then echo '\[\033[101;92m\]root\[\033[49;31m\]\[\033[01;33m\]'; else echo '\[\033[0;39m\]\u\[\033[01;33m\]'; fi)@\[\033[01;96m\]\h\[\033[0;31m\]//\[\033[0;92m\]\$(date +'%H:%M:%S %d%b%Y') \[\033[0;31m\][\[\033[0;34m\] \w \[\033[0;31m\]] \$(parse_git_branch)\033[0;36m{ \033[0;35m$TERM \033[0;36m}\r\n\033[0;31m\342\224\224 \[\033[01;33m\]\\$ \[\033[0;39m\]"
    ;;
*)
    ;;
esac
